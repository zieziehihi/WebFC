    ...
    return (
        <div className='border-t mb-3'>
            ...
            <div className='inline-flex items-center gap-2 mb-3 mt-10'>
                ...
                <hr className='border-none h-[2px] w-12 bg-gray-800'></hr>
            </div>
                        ...
                        return (
                            <div key={index} className='py-4 border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
                                <div className='flex items-start gap-6'>
                                    <img src={productData.image[0]} className='w-5 sm:w-20' alt='' />
                                    ...
                                    <div>
                                        ...
                                        <div className='flex items-center gap-5 mt-2'>
                                            ...
                                            <p className='px-2 mt-1 sm:px-3 sm:py-1 border bg-slate-50'>{item.size}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <img onClick={() => updateQuantity(item._id, item.size, 0)} src={assets.bin_icon} className='w-4 mr-4 sm:w-5 curcor-pointer' alt='' />
                            </div>
